...
public class Attack implements org.apache.thrift.TBase<Attack, Attack._Fields>, java.io.Serializable, Cloneable, Comparable<Attack> {
  ...
  public int hashCode() {
    ...
    boolean present_attackerId = true && (isSetAttackerId());
    list.add(present_attackerId);
    if (present_attackerId)
      list.add(attackerId);
  ...
  public int compareTo(Attack other) {
    ...
    lastComparison = Boolean.valueOf(isSetAttackerId()).compareTo(other.isSetAttackerId());
    if (lastComparison != 0) {
