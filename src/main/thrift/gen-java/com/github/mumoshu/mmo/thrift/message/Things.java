...
public class Things implements org.apache.thrift.TBase<Things, Things._Fields>, java.io.Serializable, Cloneable, Comparable<Things> {
  ...
  public Things(Things other) {
    if (other.isSetTs()) {
      List<Thing> __this__ts = new ArrayList<Thing>(other.ts.size());
